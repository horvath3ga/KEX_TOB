```mermaid
erDiagram
    msk_tob_allashirdetesek ||--o{ msk_kex_allasajanlatok : "msk_kex_allasajanlatokID"
    ...
    msk_tob_keresesikerelem ||--o{ msk_tob_allashirdetesek : "Idkeresesikerelem"
    msk_tob_LookupList ||--o{ msk_tob_allashirdetesek : "StatuszID"
    msk_tob_vegzettsegiszint ||--o{ msk_tob_allashirdetesek : "VegzettsegiszintID"
    ...
    msk_tob_keresesikerelemstatusz ||--o{ msk_tob_keresesikerelem : "StatuszID"
    msk_tob_teruletiigazgatosagok ||--o{ msk_tob_keresesikerelem : "TeruletiigazgatosagID"
    msk_tob_szakterulet ||--o{ msk_tob_keresesikerelem : "SzakteruletID"
    msk_tob_szerzodesfajta ||--o{ msk_tob_keresesikerelem : "SzerzodesfajtaID"
    msk_tob_telepulesek ||--o{ msk_tob_keresesikerelem : "MunkavegzeshelyeID"
    msk_tob_munkakoricsoport ||--o{ msk_tob_keresesikerelem : "MunkakorcsoportID"
    msk_tob_foglalkoztatasifok ||--o{ msk_tob_keresesikerelem : "FoglalkoztatasifokID"
    msk_tob_kepzesfajta ||--o{ msk_tob_keresesikerelem : "Kepzes_fajtaID"
    msk_tob_kepzesjelleg ||--o{ msk_tob_keresesikerelem : "Kepzes_szakiranyID"
    ORN_SZI_Company ||--o{ msk_tob_keresesikerelem : "Idceg"
    msk_tob_keresesikerelem ||--o{ msk_tob_keresesikerelem_vezetok : "Idkeresesikerelem"
    ORN_SZI_Company ||--o{ msk_tob_vallalatleiras : "Idceg"
    ORN_SZI_Company ||--o{ msk_tob_csatornaszerzodes : "Idceg"
    msk_tob_hirdetesicsatornak ||--o{ msk_tob_csatornaszerzodes : "HirdetesicsatornaID"
    msk_tob_keresesikerelem ||--o{ msk_tob_pozicio : "Idkeresesikerelem"
    msk_tob_LookupList ||--o{ msk_tob_pozicio : "StatuszID"
    msk_tob_torlesindok ||--o{ msk_tob_pozicio : "TorlesIndokID"
    msk_tob_keresesikerelem ||--o{ msk_tob_headpozicio : "Idkeresesikerelem"
    msk_tob_LookupList ||--o{ msk_tob_headpozicio : "Poziciotipus"
    ...
    ORN_SZI_Company {
        varchar AllasVallatKod "47158.stb."
    }
    msk_tob_LookupList {
        int_FK LookupListID
        int_FK GroupNum
