```mermaid
erDiagram
    msk_kex_jelentkezok ||--o{ msk_kex_interju : "idjelentkezo"
    msk_kex_LookupList ||--o{ msk_kex_interju : "ideredmeny"
    msk_kex_LookupList ||--o{ msk_kex_interju : "iddolgozik"
    msk_kex_LookupList ||--o{ msk_kex_interju : "idmegjelent"
    msk_kex_jelentkezok ||--o{ msk_kex_ajanlat : "idjelentkezo"
    msk_kex_LookupList ||--o{ msk_kex_ajanlat : "idelfogadva"
    msk_kex_LookupList ||--o{ msk_kex_ajanlat : "idtovabbi_egyeztetes"
    msk_tob_pozicio ||--o{ msk_kex_ajanlat : "PozicioID"
    msk_tob_pozicio ||--o{ msk_kex_ajanlat : "PozicioIDLast"
    people ||--o{ msk_kex_allasajanlatok : "idtoborzo1"
    people ||--o{ msk_kex_allasajanlatok : "idtoborzo2"
    people ||--o{ msk_kex_allasajanlatok : "idvezeto"
    msk_kex_tanfolyamhelyek ||--o{ msk_kex_allasajanlatok : "idtanfolyamhely"
    msk_kex_tanfolyamtipusok ||--o{ msk_kex_allasajanlatok : "idtanfolyamtipus"
    msk_kex_lezarasindokok ||--o{ msk_kex_allasajanlatok : "Idlezarasindok"
    msk_kex_allasajanlatok ||--o{ msk_kex_gdpr_jelentkezok : "idallasajanlat"
    msk_kex_hash ||--o{ msk_kex_gdpr_jelentkezok : "HashID"
    msk_kex_mananonindokok ||--o{ msk_kex_gdpr_jelentkezok : "Idanonindok"
    msk_kex_jelentkezok ||--o{ msk_kex_teszt : "idjelentkezo"
    msk_kex_teszttipusok ||--o{ msk_kex_teszt : "idteszttipus"
    msk_kex_LookupList ||--o{ msk_kex_teszt : "idmegirta"
    msk_kex_LookupList ||--o{ msk_kex_teszt : "ideredmeny"
    msk_kex_jelentkezok ||--o{ msk_kex_orvosi : "idjelentkezo"
    msk_kex_orvositipusok ||--o{ msk_kex_orvosi : "idorvositipus"
    msk_kex_LookupList ||--o{ msk_kex_orvosi : "idelkezdte"
    msk_kex_LookupList ||--o{ msk_kex_orvosi : "ideredmeny"
    msk_kex_allasajanlatok ||--o{ msk_kex_jelentkezok : "idallasajanlat"
    msk_kex_ertesuleshelyek ||--o{ msk_kex_jelentkezok : "honnanertesult"
    msk_kex_LookupList ||--o{ msk_kex_jelentkezok : "idcv_toborzo"
    msk_kex_LookupList ||--o{ msk_kex_jelentkezok : "idcv_vezeto"
    msk_kex_LookupList ||--o{ msk_kex_jelentkezok : "idtanfolyamos"
    msk_kex_tanfolyamhelyek ||--o{ msk_kex_jelentkezok : "idtanfolyamhely"
    msk_kex_tanfolyamtipusok ||--o{ msk_kex_jelentkezok : "idtanfolyamtipus"
    msk_kex_LookupList ||--o{ msk_kex_jelentkezok : "idmap_dokumentacio"
    msk_kex_LookupList ||--o{ msk_kex_jelentkezok : "idfelveve"
    msk_kex_elutasitasindokok ||--o{ msk_kex_jelentkezok : "idelutasitasindok"
    msk_kex_visszalepesindokok ||--o{ msk_kex_jelentkezok : "idvisszalepesindok"
    msk_kex_szin ||--o{ msk_kex_jelentkezok : "idszin"
    msk_kex_LookupList ||--o{ msk_kex_jelentkezok : "tanfolyamos"
    msk_kex_hash ||--o{ msk_kex_jelentkezok : "HashID"
    msk_kex_ajanloszelvenyforrasa ||--o{ msk_kex_jelentkezok : "MAPAjanloszelvenyForrasa"
    msk_kex_LookupList ||--o{ msk_kex_jelentkezok : "AI_idstatusz"
    people ||--o{ msk_kex_allasajanlat_vezetok : "Idvezeto"
    msk_kex_allasajanlatok ||--o{ msk_kex_allasajanlat_vezetok : "idallasajanlat"
    msk_kex_LookupList ||--o{ msk_kex_allasajanlat_vezetok : "Mjgy"
    msk_kex_jelentkezok ||--o{ msk_kex_felvstatusz : "Idjelentkezo"
    msk_kex_LookupList ||--o{ msk_kex_felvstatusz : "Idfelvstatusz"
    msk_kex_elutasitasindokok ||--o{ msk_kex_felvstatusz : "Idelutasitasindok"
    msk_kex_visszalepesindokok ||--o{ msk_kex_felvstatusz : "Idvisszalepesindok"
    msk_kex_jelentkezok ||--o{ msk_kex_mananonindok : "Idjelentkezo"
    msk_kex_mananonindokok ||--o{ msk_kex_mananonindok : "Idanonindok"
    msk_kex_hash ||--o{ msk_kex_jelentkezesek : "Hash"
